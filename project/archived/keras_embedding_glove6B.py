...
mlp = "mlp" in sys.argv # Add FC layers after embedding?
cnn = "cnn" in sys.argv # Add Conv layers after embedding?
trainable = "trainable" in sys.argv # Are glove embeddings trainable?
...
# history = model.fit(trX, to_categorical(trY), epochs=5, verbose=1, batch_size=32, validation_data=(teX, to_categorical(teY)))
history = model.fit(trX, to_categorical(trY), epochs=10, verbose=1, batch_size=1024, validation_data=(teX, to_categorical(teY)))
